...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <a href="<?= Url::toRoute(['/']) ?>"><img src="<?= $directoryAsset ?>/img/logo.png"
                                                                   alt="SmartAdmin"> </a></span>
    ...
    <div class="pull-right">
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <img src="<?= $directoryAsset ?>/img/avatars/sunny.png" alt="John Doe" class="online"/>
                </a>
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a href="profile.html" class="padding-10 padding-top-0 padding-bottom-0"> <i
                                    class="fa fa-user"></i> <u>П</u>рофиль</a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <a href="<?= Url::toRoute(['site/logout']) ?>" class="padding-10 padding-top-5 padding-bottom-5"
                           data-action="userLogout"><i
                                    class="fa fa-sign-out fa-lg"></i> <strong><u>В</u>ыход</strong></a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <div id="logout" class="btn-header transparent pull-right">
            <span> <a href="<?= Url::toRoute(['site/logout']) ?>" title="Sign Out" data-action="userLogout"
