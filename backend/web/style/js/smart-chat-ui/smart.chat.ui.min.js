        ...
        "options": {
            ...
            "boxManager": {
                "init": function (a) {
                    ...
                    var a = this;
                    a.elem.uiChatboxTitlebar.effect("highlight", {}, 300), a.elem.uiChatbox.effect("bounce", {"times": 2}, 300, function () {
            ...
            var b = this, c = b.options, d = c.title || "No Title",
                ...
                j = ((b.uiChatboxLog = b.element).addClass("ui-widget-content ui-chatbox-log custom-scroll").appendTo(i), (b.uiChatboxInput = a("<div></div>")).addClass("ui-widget-content ui-chatbox-input").click(function (a) {
                }).appendTo(i)),
