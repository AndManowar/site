function runAllForms() {
    $.fn.slider && $(".slider").slider(), $.fn.select2 && $("select.select2").each(function () {
        ...
        var e = $(this), t = e.attr("data-mask") || "error...", a = e.attr("data-mask-placeholder") || "X";
        ...
        var e = $(this), t = e.attr("data-dateformat") || "dd.mm.yy";
        e.datepicker({
            dateFormat: t,
...
function runAllCharts() {
    if ($.fn.sparkline) {
        var e, t, a, o, n, i, r, l, s, d, c, h, u, p, f, g, m, v, b, k, w, C, y, x, _, S, A, j, D, R, M, T, L, W, F, B,
            E, z, N, P, O, U, q, I, J, Y, H, Q, V, X, K, G, Z, ee, te, ae, oe, ne, ie, re, le, se, de, ce, he, ue, pe,
            fe, ge, me, ve, $e;
        $(".sparkline:not(:has(>canvas))").each(function () {
            var be = $(this), ke = be.data("sparkline-type") || "bar";
    ...
    $.fn.easyPieChart && $(".easy-pie-chart").each(function () {
        var e = $(this), t = e.css("color") || e.data("pie-color"), a = e.data("pie-track-color") || "rgba(0,0,0,0.04)",
...
function loadScript(e, t) {
    if (jsArray[e]) debugState && root.root.console.log("This script was already loaded %c: " + e, debugStyle_warning); else {
        var a = jQuery.Deferred(), o = document.getElementsByTagName("body")[0], n = document.createElement("script");
...
function loadURL(e, t) {
    debugState && root.root.console.log("Loading URL: %c" + e, debugStyle), $.ajax({
        ...
        success: function (e) {
            t.css({opacity: "0.0"}).html(e).delay(50).animate({opacity: "1.0"}, 300), e = null, t = null
        },
...
function drawBreadCrumb(e) {
    var t = $("nav li.active > a"), a = t.length;
            ...
            var e = {
                userLogout: function (e) {
                    ...
                    $.SmartMessageBox({
                        ...
                        content: e.data("logout-msg") || "Вы уверены, что хотите выйти",
                        buttons: "[Нет][Да]"
                    }, function (e) {
                        "Да" == e && ($.root_.addClass("animated fadeOutUp"), setTimeout(t, 1e3))
                    })
                    ...
                    shortcut_dropdown.is(":visible") ? e() : (shortcut_dropdown.animate({height: "show"}, 200, "easeOutCirc"), $.root_.addClass("shortcut-on")), shortcut_dropdown.find("a").click(function (t) {
...
initApp.addDeviceType(), initApp.menuPos(), jQuery(document).ready(function () {
    ...
    function o() {
        n = t[l](function () {
            i.each(function () {
                var t, a, o = e(this), n = e.data(this, d);
                try {
                    t = o.width()
                } catch (e) {
                    t = o.width
    ...
    var n, i = e([]), r = e.resize = e.extend(e.resize, {}), l = "setTimeout", s = "resize", d = s + "-special-event",
        c = "delay";
    r[c] = throttle_delay, r.throttleWindow = !0, e.event.special[s] = {
        setup: function () {
            ...
            i = i.add(t);
            try {
                e.data(this, d, {w: t.width(), h: t.height()})
            } catch (a) {
                e.data(this, d, {w: t.width, h: t.height})
            }
            1 === i.length && o()
...
if ($.fn.extend({
        jarvismenu: function (e) {
            var t = {accordion: "true", speed: 200, closedSign: "[+]", openedSign: "[-]"}, a = $.extend(t, e),
                o = $(this);
